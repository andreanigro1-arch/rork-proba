...
import { Settings, Clock, Dumbbell, TrendingUp, ChevronRight } from "lucide-react-native";
        ...
        <View style={styles.calendarCard}>
          ...
          <View style={styles.dayHeaders}>
            {["S", "M", "T", "W", "T", "F", "S"].map((d, i) => (
              <Text key={`dh-${i}`} style={styles.dayHeader}>
                {d}
              </Text>
            ))}
          </View>
          <View style={styles.calendarGrid}>
            {calendarDays.map((cell, idx) => (
              <View key={`cal-${idx}`} style={styles.calendarCell}>
                {!cell.empty && (
                ...
                >
                  ...
                  <View style={styles.historyMeta}>
                    <Text style={styles.historyMetaText}>
                      {durationMin}min · {Math.round(totalVolume).toLocaleString()} {unitLabel} ·{" "}
                      {totalReps} reps
                    </Text>
                  </View>
                </TouchableOpacity>
